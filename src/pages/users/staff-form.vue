<template>
    <div class="login-card standard-width page-body-container">
        <back-navigation :title="$t('familyMembers.addStaffMember')" backLink="Family Members List" />
        <div class="add-family-member-form">
            <div class="row">
                <div class="col-xl-4 col-lg-6">
                    <div class="custom-login-input-groups same-height">
                        <multiselect v-model="selectedOption" :options="loginOptions" track-by="value" label="text"
                            :preselectFirst="true" @input="itemSelected" :placeholder="$t('login.selectNationalityId')"
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="custom-login-input-groups same-height">
                        <multiselect v-model="selectedRole" :options="rolesList" track-by="id" label="title"
                            :preselectFirst="true" :placeholder="$t('login.selectNationalityId')"
                            :selectLabel="$t('selectLabel')" :selectedLabel="$t('selectedLabel')"
                            :deselectLabel="$t('deselectLabel')">
                            <template slot="placeholder">
                                <div class="multiselect__with-icon">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="registerForm.first_name" :state="registerFormState.first_name"
                            :placeholder="$t('familyMembers.firstName')" :formatter="alphabetsOnly"></b-form-input>
                    </b-input-group>
                </div>
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="registerForm.middle_name" :placeholder="$t('familyMembers.middleName')"
                            :formatter="alphabetsOnly"></b-form-input>
                    </b-input-group>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="registerForm.family_name" :state="registerFormState.family_name"
                            :placeholder="$t('familyMembers.familyName')" :formatter="alphabetsOnly"></b-form-input>
                    </b-input-group>
                </div>
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="userId" :state="registerFormState.userId"
                            :placeholder="$t('familyMembers.' + selectedItem.placeholder)" type="number"></b-form-input>
                    </b-input-group>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="registerForm.email_address" :state="registerFormState.email_address"
                            :placeholder="$t('familyMembers.emailAddress')" type="email"></b-form-input>
                    </b-input-group>
                </div>
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="registerForm.phone_number" :state="registerFormState.phone_number"
                            :placeholder="$t('familyMembers.phoneNumber')" :formatter="formatNumber"></b-form-input>
                    </b-input-group>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <div class="custom-login-input-groups same-height">
                        <multiselect v-model="registerForm.nationality_id" :options="nationalities" label="nationality"
                            :placeholder="$t('familyMembers.selectNationality')" track-by="code"
                            :selectLabel="$t('selectLabel')" :selectedLabel="$t('selectedLabel')"
                ...
                <div class="col-xl-4 col-md-6">
                    <ash-datepicker :placeholder="$t('familyMembers.addDOB')" v-model="registerForm.dob" class="same-height"
                        disableDate="backward" />
                    <div class="custom-state-invalid icon mr-3" :class="{
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <b-input-group class="custom-login-input-groups same-height">
                        <b-form-input v-model="registerForm.location" :state="registerFormState.location"
                            :placeholder="$t('familyMembers.yourLocation')"></b-form-input>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="custom-login-input-groups same-height">
                        <multiselect v-model="registerForm.gender" :options="genderList"
                            :placeholder="$t('familyMembers.selectGender')" :selectLabel="$t('selectLabel')"
                            :selectedLabel="$t('selectedLabel')" :deselectLabel="$t('deselectLabel')"></multiselect>
                        <div class="custom-state-invalid icon" :class="{
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-12">
                    <div class="custom-login-input-groups file-upload-container">
                        ...
                        <vue-dropzone @vdropzone-file-added="fileUpload" @vdropzone-removed-file="removeFile"
                            :options="validationdropzoneOptions" ref="fileUpload" id="validationdropzone"
